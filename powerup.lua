...
function freeze(n)
	...
	flux.to(g.cowsettings, 0, { speedmultiplier = n }):after(g.cowsettings, 1, {speedmultiplier = 1}):delay(Powerup.dur)
end
...
function cameraentropy(n)
	flux.to(g, 0, { camentropy = n }):after(g, 0, { camentropy = 1 }):delay(Powerup.dur)
end
